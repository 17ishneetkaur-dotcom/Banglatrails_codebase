...
const MOOD_FILTERS = ["all", "spiritual", "historical", "artistic", "festive", "nature"];
...
export default function CulturalGuide() {
  ...
  const filteredDistricts = activeMood === "all"
    ? districts
...
Provide a warm, informative, and culturally rich answer in 3-5 sentences. Recommend specific districts when relevant. Be poetic but factual. Use a warm, storytelling tone.`,
    });
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="font-body text-sm text-muted-foreground max-w-md mx-auto">
              Ask anything about Bengal's heritage, food, festivals, or travel — get personalized cultural insights.
            </p>
          </motion.div>
              ...
              {response && (
                ...
                >
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-xs font-body font-medium text-accent">Cultural Guide</span>
                  </div>
            ...
            {filteredDistricts.map((d, i) => (
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  >
                    <MapPin className="w-3.5 h-3.5" style={{ color: d.accentColor }} />
                  </div>
                  <div>
                    ...
                    <div className="flex gap-1 mt-2">
                      {d.moodTags.map(tag => (
                        <span key={tag} className="text-[9px] px-2 py-0.5 rounded-full bg-muted/50 text-muted-foreground font-body capitalize">
                          {tag}
                        </span>
                      ))}
                    </div>
